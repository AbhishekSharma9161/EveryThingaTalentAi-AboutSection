...
const Component = () => {
    const obj = [{
        "emoji": <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
    ...
    return (
        <div className='md:flex gap-10 w-full'>
            <div className="mb-10 w-full max-w-400 h-170 hover:scale-x-[1.05] duration-200 ease-in-out relative md:mb-0 md:min-w-50 md:max-w-200 hidden lg:block">
                <Image className='rounded-2xl' src={"/assests/section5.webp"} alt="How We Thrive section image" fill />
            </div>
